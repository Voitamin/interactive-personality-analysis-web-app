...
const sevenWonders = {
  ...
  persona: {
    ...
    kicker: '超级隐藏人格已激活',
    priority: 700,
    summary: '【 警告：常规解析协议已崩溃，转为异常实体收容报告 】\n\n在 8192 种命运的分支中，你精准地踩中了所有通向深渊的雷区。系统已放弃将你定义为“玩家”，你是一个由七种机厅极端业障缝合而成的矛盾体。\n\n你的双手刻满了无可救药的肌肉错误（手癖），大脑却塞满了纸上谈兵的满分理论（眼高手低）；你永远在越级死磕的泥潭里挣扎，在阴间粪谱中狂舞；你会因为一个失误当场红温破防，却又能分出余光死死锁定对位者的心智。\n\n极端的功利算计与极端的哗众取宠在你身上迎面相撞。你已经不再是单纯在打音游了，你是这座机厅里游荡的都市传说，是一个行走的系统 Bug。\n\n当这七道极端的虹光同时亮起，唯有削除神的《7 Wonders》配得上你这满身的业障。收下这份属于第八大奇迹的最高殊荣，然后，离我的机台远一点。',
    song: {
      title: '《7 Wonders》',
